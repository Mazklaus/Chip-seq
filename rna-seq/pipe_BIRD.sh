...
#Since this script is a bird version all of the environment is handle by conda
#however samtools encounter problem wih conda so it will be load here from bird
